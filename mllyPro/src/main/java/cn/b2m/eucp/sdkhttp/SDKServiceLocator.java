...
//    	 private java.lang.String SDKService_address =PropertyResourceBundle.getBundle("config").getString("uri");
    ...
    public cn.b2m.eucp.sdkhttp.SDKClient getSDKService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            cn.b2m.eucp.sdkhttp.SDKServiceBindingStub _stub = new cn.b2m.eucp.sdkhttp.SDKServiceBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (cn.b2m.eucp.sdkhttp.SDKClient.class.isAssignableFrom(serviceEndpointInterface)) {
                cn.b2m.eucp.sdkhttp.SDKServiceBindingStub _stub = new cn.b2m.eucp.sdkhttp.SDKServiceBindingStub(new java.net.URL(SDKService_address), this);
                _stub.setPortName(getSDKServiceWSDDServiceName());
                return _stub;
            }
        }
