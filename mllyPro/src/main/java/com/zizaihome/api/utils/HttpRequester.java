...
public class HttpRequester {
	...
	public static void main(String[] args) {
		try {
			...
			LogUtils.log.info(hr.getUrlString());
			LogUtils.log.info(hr.getProtocol());
			LogUtils.log.info(hr.getHost());
			LogUtils.log.info(hr.getPort()+"");
			LogUtils.log.info(hr.getContentEncoding());
			LogUtils.log.info(hr.getMethod());

			LogUtils.log.info(hr.getContent());
