...
//    
    //把测绘局转换成gps
    public Point dcj2wgs(double x , double y){
    	Point gp = getEncryPoint(x, y);
    	Point dp = new Point();
